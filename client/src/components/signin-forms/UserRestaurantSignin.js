...
import Image from '../../assets/back-rest.jpg'
...
function UserRestaurantSignIn({history}) {
  ...
  const [user,setUser]=useState({
    ...
    let handleSubmit= (e)=>{
        ...
        signin({userType:'restaurant',email,password})
          .then(data=>{
              if(data.error){
                setUser({
                  ...user,
...
export default withRouter(UserRestaurantSignIn)